...
The system clipboard only remembers the last thing you copied.

Folio keeps a persistent history instead, making previously copied text and images available without changing how you use your clipboard. It is designed to stay out of the way, prioritizing speed, simplicity, and local storage over unnecessary features.
